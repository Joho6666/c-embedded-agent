...
class CredentialRow(Base):
    ...
    stats_month: Mapped[str] = mapped_column(String(7), default="")
...
class RequestLogRow(Base):
    ...
    client_disconnected: Mapped[bool] = mapped_column(Boolean, default=False)
...
class ModelPricingRow(Base):
    ...
    reasoning_per_1m: Mapped[float] = mapped_column(Float, default=0)
