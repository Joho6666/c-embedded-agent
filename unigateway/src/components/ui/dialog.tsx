  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 max-h-[88vh] w-[min(520px,calc(100vw-24px))] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-md border border-border bg-card shadow-2xl",
          wide && "w-[min(760px,calc(100vw-24px))]",
          className,
        )}
      >
        {(title || description) && (
